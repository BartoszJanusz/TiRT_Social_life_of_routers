...
%%  Metadane dokumentu 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Analiza sieci routerów przy użyciu algorytmów grafowych}
...
\include{acronyms} %skróty można sobie pominąć
\chapterstyle{default}
\include{chapters/1_wstep}
\include{chapters/2_teoria}
\include{chapters/3_opis_rozwiazania}
\include{chapters/4_podsumowanie}
